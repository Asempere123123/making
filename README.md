...
Y ademas al estar en el puerto 8000 NO va con eduroam. [web](http://ddns.asempere.net/). Ademas tiene las meta tags para que se pueda añadir como webapp en el movil, asi que en teoria si la abres en saphari en iphone o en chrome en android (no he probado en android) puedes darle a que la añada como aplicacion a la pantalla de inicio. Sino hay muchas formas de convertir una aplicacion web a nativa. La mas facil seria meterla en un webview del appinventor o sino habra que embeberla en un webview del motor que se este utilizando.
